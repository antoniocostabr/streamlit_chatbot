...
st.markdown(
    ...
    **GitHub:** [antoniocostabr](https://github.com/antoniocostabr)
    ...
    6. A `config.yalm` file contains authentication data. For testing, use `login=jsmith` and `password=abc`(don't forget to **Update** this file if you intend to deploy this!!)
